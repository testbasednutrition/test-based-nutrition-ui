...
const DEFAULT_WORDS = ["Join", "the", "Partner", "Hub", "Academy"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full py-12 px-4 relative overflow-hidden bg-neutral-950 rounded-3xl">
      <canvas
        ref={canvasRef}
        className="max-w-[1000px] w-full h-auto"
        style={{ aspectRatio: "2/1" }}
      />
      <div className="absolute bottom-6 left-0 right-0 text-white text-sm text-center">
        <p className="text-neutral-400 text-xs">
          Interactive Canvas • Right-click and hold to scatter particles
        </p>
      </div>
    </div>
  )
