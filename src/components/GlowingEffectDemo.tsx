    ...
    <li className={`min-h-[14rem] list-none ${area}`}>
      <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3">
        <GlowingEffect
          ...
          inactiveZone={0.01}
        />
        <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl border-0.75 p-6 shadow-sm dark:shadow-[0px_0px_27px_0px_#2D2D2D] md:p-6">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            ...
            <div className="space-y-2">
              ...
              <h4 className="text-sm leading-[1.125rem] font-sans text-muted-foreground md:text-base md:leading-[1.375rem]">
                {description}
              </h4>
            </div>
          </div>
