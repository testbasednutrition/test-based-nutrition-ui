           ...
           <div className="w-full lg:w-5/12 text-center lg:text-left flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <button 
                  ...
                  className="border border-gray-300 hover:bg-gray-50 transition-colors bg-white text-gray-800 px-8 py-3.5 rounded-md font-bold text-[15px] flex justify-center items-center gap-2">
      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 pb-8 md:pb-16 mb-16">
        ...
        <div className="mb-20 xl:mb-24 px-4 lg:px-0">
          <div className="text-center mb-12 border-t border-gray-100 pt-10">
             <h2 className="font-playfair text-[28px] md:text-[36px] font-bold text-gray-900 tracking-wider mb-3 uppercase">LEADERS IN PAIN, FATIGUE & INFLAMMATION</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-4 lg:gap-0 md:divide-x divide-[#dbd4c9]">
              ...
              <div className="group flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6 lg:gap-8 md:pr-4 lg:pr-14">
                 ...
                 <div className="flex flex-col flex-1 pl-0 pt-2 sm:pt-0">
                   ...
                   <p className="font-playfair italic text-[#111827] text-[12px] sm:text-[14px] leading-relaxed max-w-sm mx-auto sm:mx-0 opacity-80 border-l-2 border-[#9f1e13] pl-3">"Pain is not always just structural — it may be influenced by how the body is functioning at a deeper level."</p>
                 </div>
              </div>
              ...
              <div className="group flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6 lg:gap-8 md:pl-4 lg:pl-14">
                 ...
                 <div className="flex flex-col flex-1 pl-0 pt-2 sm:pt-0">
                   ...
                   <p className="font-playfair italic text-[#111827] text-[12px] sm:text-[14px] leading-relaxed max-w-sm mx-auto sm:mx-0 opacity-80 border-l-2 border-[#9f1e13] pl-3">"You can treat the area of pain — but unless you understand what’s driving it, it often returns."</p>
                 </div>
              </div>
          </div>
        </div>
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-[#dbd4c9] flex flex-col">
                 <div className="h-[85px] shrink-0 flex flex-col justify-end pb-4">
                   <div className="flex flex-col justify-end h-full">
                     ...
                     <p className="text-[13px] text-gray-500 font-medium flex items-center gap-1.5">+ £39/mo <span className="text-[#9f1e13] font-bold text-[11px] uppercase bg-[#dbd4c9] px-1.5 py-[2px] rounded">optional support</span></p>
                   </div>
                 </div>
