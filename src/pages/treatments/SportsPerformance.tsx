...
{/* SECTION 3 — SPECIALIST LEADS */}
        <div className="mb-20 xl:mb-24 px-4 lg:px-0">
          <div className="text-center mb-12 border-t border-gray-100 pt-10">
             <h2 className="font-playfair text-[28px] md:text-[36px] font-bold text-gray-900 tracking-wider mb-3 uppercase">LEADERS IN SPORTS PERFORMANCE</h2>
             <p className="font-bold text-[#9f1e13] text-[13px] uppercase tracking-widest flex items-center justify-center gap-2"><span className="w-1.5 h-1.5 bg-[#9f1e13] rounded-full" /> Built by those working at the highest level of sport <span className="w-1.5 h-1.5 bg-[#9f1e13] rounded-full" /></p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-4 lg:gap-0 md:divide-x divide-[#dbd4c9]">
              ...
              <div className="group flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6 lg:gap-8 md:pr-4 lg:pr-14">
                 ...
                 <div className="flex flex-col flex-1 pl-0 pt-2 sm:pt-0">
                   ...
                   <p className="font-playfair italic text-[#111827] text-[12px] sm:text-[14px] leading-relaxed max-w-sm mx-auto sm:mx-0 opacity-80 border-l-2 border-[#9f1e13] pl-3">"Performance is driven by the systems behind it — not just the output you see."</p>
              ...
              <div className="group flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6 lg:gap-8 md:pl-4 lg:pl-14">
                 ...
                 <div className="flex flex-col flex-1 pl-0 pt-2 sm:pt-0">
                   ...
                   <p className="font-playfair italic text-[#111827] text-[12px] sm:text-[14px] leading-relaxed max-w-sm mx-auto sm:mx-0 opacity-80 border-l-2 border-[#9f1e13] pl-3">"Progress comes from identifying constraints and removing them with precision."</p>
                 </div>
              </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 items-stretch">
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-[#dbd4c9] flex flex-col">
                 <div className="h-[85px] shrink-0 flex flex-col justify-end pb-4">
                   <div className="flex flex-col justify-end h-full">
                     ...
                     <p className="text-[13px] text-gray-500 font-medium flex items-center gap-1.5">+ £39/mo <span className="text-[#9f1e13] font-bold text-[11px] uppercase bg-[#dbd4c9] px-1.5 py-[2px] rounded">Save 29%</span></p>
                   </div>
                 </div>
            ...
            <div className="bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm flex flex-col hover:border-[#bdae97] hover:-translate-y-2 hover:shadow-xl transition-all duration-300 transform-gpu will-change-transform">
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-gray-100 flex flex-col">
                 ...
                 <div className="flex-grow flex flex-col justify-between">
                   ...
                   <div className="bg-[#faf8f5] p-4 rounded-xl border border-[#dbd4c9] w-full mt-auto">
                     <p className="font-bold text-[11px] text-[#9f1e13] uppercase tracking-widest mb-1">Delivered By</p>
            ...
            <div className="bg-[#9f1e13] border border-white/10 p-8 rounded-[2rem] shadow-xl hover:shadow-2xl flex flex-col relative overflow-hidden group hover:-translate-y-2 transition-all duration-300 transform-gpu will-change-transform isolate">
               ...
               <div className="h-[100px] shrink-0 mb-2 relative z-10 flex flex-col">
                 ...
                 <p className="text-[11px] font-bold text-[#dbd4c9] uppercase tracking-widest">Private 1:1 with Doctor / Coach</p>
               </div>
               ...
               <div className="flex-grow mb-6 space-y-3 relative z-10">
                 ...
                 <div className="flex items-start gap-3"><CheckCircle2 className="w-4 h-4 text-[#dbd4c9] shrink-0 mt-0.5" strokeWidth={2.5}/><span className="text-[13px] text-white/90 font-medium leading-snug">Follow-Up & Second Review</span></div>
               </div>
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-white/10 flex flex-col relative z-10">
                 ...
                 <div className="flex-grow flex flex-col justify-between">
                   ...
                   <div className="bg-white/5 p-3.5 rounded-xl border border-white/10 w-full mt-auto">
                     ...
                     <div className="flex items-start gap-2 mb-1.5"><div className="w-1 h-1 rounded-full bg-[#dbd4c9] shrink-0 mt-1.5"></div><p className="text-[12px] text-white font-bold leading-tight">Dr Ishtiaq Rehman <span className="text-white/50 font-normal">(England FA)</span></p></div>
                     <div className="flex items-start gap-2 mb-1.5"><div className="w-1 h-1 rounded-full bg-[#dbd4c9] shrink-0 mt-1.5"></div><p className="text-[12px] text-white font-bold leading-tight">Neil Parsley <span className="text-white/50 font-normal">(Man City, Team GB)</span></p></div>
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 relative z-10 flex-grow">
                     <div className="xl:col-span-8 flex flex-col justify-between">
                         ...
                         <div className="mt-auto">
                             <PartnerLeadForm sourcePage="Sports Performance" />
                         </div>
                     </div>
