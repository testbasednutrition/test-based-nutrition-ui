        ...
        <div className="w-full mt-24 lg:mt-32 max-w-[1400px] mx-auto px-4 mb-24">
         ...
         <div className="w-full max-w-4xl mx-auto px-4 mb-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
               <button onClick={() => openQuiz()} className="bg-[#9f1e13] text-white px-8 py-4 rounded-xl font-bold text-[14px] uppercase tracking-wider hover:bg-[#80180f] transition-colors shadow-sm">
                 Start Your Journey
               </button>
