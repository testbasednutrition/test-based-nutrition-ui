          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 items-stretch">
            ...
            <div className="bg-[#faf8f5] border border-[#dbd4c9] p-8 rounded-[2rem] shadow-md flex flex-col relative hover:-translate-y-2 hover:shadow-xl transition-all duration-300 transform-gpu will-change-transform">
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-[#dbd4c9] flex flex-col">
                 ...
                 <button onClick={() => openBooking("TBN Foundations (6-Month Programme)")} className="w-full h-[52px] shrink-0 text-[13px] font-bold tracking-widest uppercase bg-[#9f1e13] text-white rounded-full hover:bg-[#861910] transition-colors shadow-md mb-6 cursor-pointer">
                   Start Foundations
                 </button>
                 <div className="flex-grow">
                   <p className="font-montserrat text-[13px] text-gray-500 leading-relaxed text-center">
            ...
            <div className="bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm flex flex-col hover:border-[#9f1e13] hover:-translate-y-2 hover:shadow-xl transition-all duration-300 transform-gpu will-change-transform">
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-gray-100 flex flex-col">
                 ...
                 <button onClick={() => openBooking("TBN Advanced Review (1:1 Strategic)")} className="w-full h-[52px] shrink-0 text-[13px] font-bold tracking-widest uppercase bg-[#9f1e13] text-white rounded-full hover:bg-[#861910] transition-colors shadow-md mb-6 cursor-pointer">
