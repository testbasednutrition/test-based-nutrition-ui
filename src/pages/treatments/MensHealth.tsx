      ...
      <div className="w-full relative bg-[#faf8f5] flex flex-col overflow-hidden min-h-[600px] lg:min-h-[700px] lg:h-[calc(100vh-96px)]">
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-10 lg:gap-16 pt-12 pb-12 lg:py-0 justify-between flex-grow">
           <div className="w-full lg:w-5/12 text-center lg:text-left flex flex-col justify-center">
              <h3 className="font-playfair text-[#9f1e13] font-bold tracking-widest uppercase text-sm mb-4">MEN'S HEALTH</h3>
              <h1 className="font-playfair text-[3rem] md:text-[3.5rem] xl:text-[4rem] font-bold text-gray-900 leading-[1.05] mb-6">
                <span className="whitespace-nowrap">MEN’S HEALTH.</span> <br className="hidden md:block" /><span className="whitespace-nowrap">BEYOND TESTOSTERONE.</span>
              </h1>
           ...
           <div className="w-full lg:w-5/12 relative mt-auto lg:mt-0 flex justify-end items-end h-full self-end lg:pb-12 xl:pb-16 mt-8">
              <div className="w-full bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl flex flex-col sm:flex-row gap-4 justify-between items-center text-white shadow-2xl">
                ...
                <button 
                   onClick={() => openQuiz()}
                   className="shrink-0 bg-white text-[#9f1e13] border border-transparent px-5 py-2.5 rounded-full font-bold text-[13px] uppercase tracking-wider hover:bg-gray-100 transition-all shadow-md">
                  Take the Assessment
                </button>
              </div>
           </div>
      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 pb-8 md:pb-16 mb-16">
              ...
              items={[
                {
                  ...
                  href: "#",
                  image: "/images/treatments/mens-testosterone.jpg",
                },
                {
                  id: "fertility",
                ...
                },
                {
                  ...
                  href: "#",
                  image: "/images/treatments/mens-diabetes.jpg",
                },
                {
                  id: "stress",
                ...
                },
                {
                  ...
                  href: "#",
                  image: "/images/treatments/mens-ageing.jpg",
                },
                {
                  id: "gut",
                  ...
                  href: "#",
                  image: "/images/treatments/mens-gut.jpg",
                }
              ]}
            />
          </div>
        ...
        <div className="mb-20 xl:mb-24 px-4 lg:px-0">
          <div className="text-center mb-12 border-t border-gray-100 pt-10">
             <h2 className="font-playfair text-[28px] md:text-[36px] font-bold text-gray-900 tracking-wider mb-3 uppercase">LEADERS IN MEN'S HEALTH</h2>
             <p className="font-bold text-[#9f1e13] text-[13px] uppercase tracking-widest flex items-center justify-center gap-2"><span className="w-1.5 h-1.5 bg-[#9f1e13] rounded-full" /> Built by those redefining modern men's health <span className="w-1.5 h-1.5 bg-[#9f1e13] rounded-full" /></p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-4 lg:gap-0 md:divide-x divide-[#dbd4c9]">
              ...
              <div className="group flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6 lg:gap-8 md:pl-4 lg:pl-14">
                 ...
                 <div className="flex flex-col flex-1 pl-0 pt-2 sm:pt-0">
                   ...
                   <div className="font-sans text-[10px] lg:text-[12px] font-bold text-[#9f1e13] uppercase tracking-widest mb-4">Former Manchester City, Team GB, England Rugby</div>
                   <p className="font-playfair italic text-[#111827] text-[12px] sm:text-[14px] leading-relaxed max-w-sm mx-auto sm:mx-0 opacity-80 border-l-2 border-[#9f1e13] pl-3">"Energy, resilience, and performance are driven by internal systems — once identified, they can be supported with precision."</p>
                 </div>
              </div>
          </div>
        ...
        <div className="w-full mt-16 lg:mt-24 max-w-6xl mx-auto px-4">
           ...
           <div className="mt-12 bg-[#9f1e13] text-white p-8 md:p-10 rounded-3xl shadow-xl text-center space-y-4 max-w-4xl mx-auto">
             ...
             <p className="font-sans text-[14px] uppercase tracking-widest text-[#dbd4c9] font-bold">— Dr Ishtiaq Rehman</p>
           </div>
        </div>
        ...
        <div className="w-full mt-24 lg:mt-32 max-w-[1400px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 items-stretch">
            ...
            <div className="bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm flex flex-col hover:border-[#9f1e13] hover:-translate-y-2 hover:shadow-xl transition-all duration-300 transform-gpu will-change-transform">
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-gray-100 flex flex-col">
                 ...
                 <button onClick={() => openBooking("Men's Health — Free Consultation")} className="w-full h-[52px] shrink-0 text-[13px] font-bold tracking-widest uppercase border border-gray-200 text-gray-900 rounded-full hover:bg-gray-50 transition-colors shadow-sm mb-6 cursor-pointer">
            ...
            <div className="bg-[#faf8f5] border border-[#dbd4c9] p-8 rounded-[2rem] shadow-md flex flex-col relative hover:-translate-y-2 hover:shadow-xl transition-all duration-300 transform-gpu will-change-transform">
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-[#dbd4c9] flex flex-col">
                 ...
                 <button onClick={() => openBooking("Men's Health — TBN Foundations")} className="w-full h-[52px] shrink-0 text-[13px] font-bold tracking-widest uppercase bg-[#9f1e13] text-white rounded-full hover:bg-[#861910] transition-colors shadow-md mb-6 cursor-pointer">
                   Start Foundations
                 </button>
                 <div className="flex-grow">
                   <p className="font-montserrat text-[13px] text-gray-500 leading-relaxed text-center">
            ...
            <div className="bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm flex flex-col hover:border-[#9f1e13] hover:-translate-y-2 hover:shadow-xl transition-all duration-300 transform-gpu will-change-transform">
               ...
               <div className="flex-grow mb-6 space-y-3">
                 <p className="font-bold text-[11px] text-gray-400 uppercase tracking-widest mb-3">Includes</p>
                 <div className="flex items-start gap-3"><CheckCircle2 className="w-4 h-4 text-[#9f1e13] shrink-0 mt-0.5" strokeWidth={2.5}/><span className="text-[13px] text-gray-700 font-medium leading-snug">1:1 Results Review</span></div>
                 ...
                 <div className="flex items-start gap-3"><CheckCircle2 className="w-4 h-4 text-[#9f1e13] shrink-0 mt-0.5" strokeWidth={2.5}/><span className="text-[13px] text-gray-700 font-medium leading-snug">Lifestyle Alignment</span></div>
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-gray-100 flex flex-col">
                 ...
                 <button onClick={() => openBooking("Men's Health — TBN Advanced Review")} className="w-full h-[52px] shrink-0 text-[13px] font-bold tracking-widest uppercase bg-[#9f1e13] text-white rounded-full hover:bg-[#861910] transition-colors shadow-md mb-6 cursor-pointer">
            ...
            <div className="bg-[#9f1e13] border border-white/10 p-8 rounded-[2rem] shadow-xl hover:shadow-2xl flex flex-col relative overflow-hidden group hover:-translate-y-2 transition-all duration-300 transform-gpu will-change-transform isolate">
               ...
               <div className="h-[100px] shrink-0 mb-2 relative z-10 flex flex-col">
                 ...
                 <p className="text-[11px] font-bold text-[#dbd4c9] uppercase tracking-widest">Private 1:1 with Doctor or Elite Coach</p>
               </div>
               ...
               <div className="h-[360px] shrink-0 pt-6 border-t border-white/10 flex flex-col relative z-10">
                 ...
                 <button onClick={() => openBooking("Men's Health — TBN Elite Consultation")} className="w-full h-[52px] shrink-0 text-[13px] font-bold tracking-widest uppercase bg-[#dbd4c9] text-[#1c1c1c] rounded-full hover:bg-white transition-colors shadow-md mb-6 cursor-pointer">
        ...
        <div className="w-full mt-24 lg:mt-32 max-w-[1400px] mx-auto px-4 mb-24">
         ...
         <div className="w-full mt-24 max-w-4xl mx-auto px-4 mb-24">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              <AccordionItem value="item-1" className="bg-white border border-gray-200 rounded-xl px-6 py-2">
                <AccordionTrigger className="text-left font-bold text-[16px] text-gray-900 hover:text-[#9f1e13] hover:no-underline">
         ...
         <div className="w-full max-w-4xl mx-auto px-4 mb-16 text-center">
            ...
            <p className="text-[18px] text-[#9f1e13] font-bold mb-2">From fatigue and burnout to performance and longevity —</p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
               ...
               <Link to="/specialists" className="bg-white border border-gray-200 text-gray-900 px-8 py-4 rounded-xl font-bold text-[14px] uppercase tracking-wider hover:bg-gray-50 transition-colors shadow-sm text-center">
                 Find a Clinic
               </Link>
            </div>
         </div>
