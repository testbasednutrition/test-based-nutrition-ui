...
const TestingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-[85px] md:pt-[96px] bg-[#fcfaf7] font-montserrat">
      <Navbar alwaysSolid />
      
      {/* 1. HERO SECTION */}
      <div className="w-full relative bg-[#fcfaf7] flex flex-col overflow-hidden min-h-[600px] lg:min-h-[700px] lg:h-[calc(100vh-96px)]">
        <div className="absolute inset-y-0 right-0 w-full lg:w-[70%] z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#fcfaf7] via-[#fcfaf7]/70 lg:via-[#fcfaf7]/20 to-transparent"></div>
        </div>
           ...
           <div className="w-full lg:w-6/12 text-center lg:text-left flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mt-4">
                <button 
                  ...
                  className="bg-[#7a2a33] hover:bg-[#5c1c24] transition-colors text-white px-8 py-3.5 rounded-md font-bold text-[15px] flex justify-center items-center gap-2 shadow-lg">
      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 pb-8 md:pb-16 mb-16 mt-16 lg:mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-24">
           {/* Rapid */}
           <div className="bg-white p-10 md:p-12 border border-gray-200 rounded-[2rem] shadow-sm flex flex-col hover:shadow-xl hover:border-[#7a2a33]/30 transition-all">
              <div className="w-16 h-16 bg-[#fcfaf7] border border-gray-100 rounded-2xl flex items-center justify-center mb-6 shadow-sm">
                <Zap className="w-8 h-8 text-[#7a2a33]" />
              </div>
              <p className="font-bold text-gray-400 text-[12px] uppercase tracking-widest mb-3">Category 1</p>
              <h2 className="font-playfair text-[32px] md:text-[40px] font-bold text-[#7a2a33] mb-4">Rapid Point-of-Care</h2>
           ...
           {/* Root */}
           <div className="bg-[#fcfaf7] p-10 md:p-12 border border-[#e9e7dc] rounded-[2rem] shadow-md flex flex-col hover:shadow-xl hover:border-[#7a2a33]/30 transition-all">
              ...
              <h2 className="font-playfair text-[32px] md:text-[40px] font-bold text-[#7a2a33] mb-4">Deep Systemic Analysis</h2>
        ...
        <div className="w-full mt-24 mb-24 max-w-6xl mx-auto px-4">
          <div className="bg-white rounded-[2rem] p-10 md:p-16 relative overflow-hidden shadow-xl border border-gray-200 text-center">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#7a2a33]/5 to-transparent pointer-events-none"></div>

            <div className="relative z-10 mb-16">
              <h2 className="font-playfair text-[36px] md:text-[48px] font-bold text-[#7a2a33] mb-6">We provide proof, not just promises.</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10 mb-16">
               ...
               <div className="relative z-10 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#fcfaf7] border-2 border-[#7a2a33] rounded-full flex items-center justify-center mb-6 shadow-md shadow-[#7a2a33]/10">
                     <Search className="w-8 h-8 text-[#7a2a33]" />
                  </div>
                  <h3 className="font-bold text-xl text-gray-900 mb-2">1. Baseline</h3>
                  <p className="text-sm font-semibold text-[#7a2a33] uppercase tracking-widest">Get the facts</p>
               </div>

               <div className="relative z-10 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#fcfaf7] border-2 border-[#7a2a33] rounded-full flex items-center justify-center mb-6 shadow-md shadow-[#7a2a33]/10">
                     <ActivitySquare className="w-8 h-8 text-[#7a2a33]" />
                  </div>
                  <h3 className="font-bold text-xl text-gray-900 mb-2">2. Bespoke</h3>
                  <p className="text-sm font-semibold text-[#7a2a33] uppercase tracking-widest">Get your plan</p>
               </div>

               <div className="relative z-10 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#fcfaf7] border-2 border-[#7a2a33] rounded-full flex items-center justify-center mb-6 shadow-md shadow-[#7a2a33]/10">
                     <TestTube2 className="w-8 h-8 text-[#7a2a33]" />
                  </div>
                  <h3 className="font-bold text-xl text-gray-900 mb-2">3. Balance</h3>
                  <p className="text-sm font-semibold text-[#7a2a33] uppercase tracking-widest">Follow protocol</p>
               </div>

               <div className="relative z-10 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#fcfaf7] border-2 border-[#7a2a33] rounded-full flex items-center justify-center mb-6 shadow-md shadow-[#7a2a33]/10">
                     <RefreshCw className="w-8 h-8 text-[#7a2a33]" />
                  </div>
                  <h3 className="font-bold text-xl text-gray-900 mb-2">4. Benchmark</h3>
                  <p className="text-sm font-semibold text-[#7a2a33] uppercase tracking-widest">See data change</p>
               </div>
            </div>

            {/* Stat Callout */}
            <div className="relative z-10 max-w-2xl mx-auto bg-[#7a2a33] text-white p-8 rounded-2xl shadow-xl transform hover:scale-105 transition-transform cursor-default">
        ...
        <div id="foundations" className="w-full mt-24 max-w-5xl mx-auto px-4 mb-24 scroll-mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            {/* Omega Test */}
            <div className="bg-white p-10 lg:p-12 rounded-[2.5rem] border border-gray-100 shadow-lg hover:shadow-xl hover:border-[#7a2a33]/20 transition-all group flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#7a2a33]/5 rounded-full blur-2xl -mr-10 -mt-10 pointer-events-none"></div>
              <div className="flex items-center gap-5 mb-8 relative z-10">
                <div className="w-20 h-20 bg-[#fcfaf7] rounded-[1.5rem] flex items-center justify-center border border-gray-200 shadow-sm overflow-hidden p-0 shrink-0">
                  <img src="/images/test-logos/omega3balance.png" alt="Omega Balance Test" className="w-full h-full object-contain scale-[1.15]" />
                </div>
                <h3 className="font-playfair font-bold text-[28px] text-[#7a2a33] leading-tight">Inflammation &<br/>Brain Health</h3>
              </div>
              ...
              <ul className="space-y-3 mb-8 flex-grow relative z-10">
                 <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#7a2a33] shrink-0" /><span className="text-[15px] font-medium text-gray-700">Omega-6:3 balance</span></li>
                 <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#7a2a33] shrink-0" /><span className="text-[15px] font-medium text-gray-700">Cell membrane fluidity</span></li>
                 <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#7a2a33] shrink-0" /><span className="text-[15px] font-medium text-gray-700">Mental strength markers</span></li>
              </ul>
              <button className="w-full py-4 rounded-xl border-2 border-[#7a2a33] text-[#7a2a33] font-bold uppercase tracking-widest text-[13px] hover:bg-[#7a2a33] hover:text-white transition-colors">
                Order My Balance Test Kit
              </button>
            </div>
            
            {/* Gut Health */}
            <div className="bg-[#fcfaf7] p-10 lg:p-12 rounded-[2.5rem] border border-[#e9e7dc] shadow-lg hover:shadow-xl hover:border-[#7a2a33]/30 transition-all group flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#7a2a33]/10 rounded-full blur-2xl -mr-10 -mt-10 pointer-events-none"></div>
              <div className="flex items-center gap-5 mb-8 relative z-10">
                <div className="w-20 h-20 bg-white rounded-[1.5rem] flex items-center justify-center border border-gray-200 shadow-sm overflow-hidden p-0 shrink-0">
                  <BrainCircuit className="w-10 h-10 text-[#7a2a33]" />
                </div>
                <h3 className="font-playfair font-bold text-[28px] text-[#7a2a33] leading-tight">The Second<br/>Brain</h3>
              </div>
              <p className="text-[16px] text-gray-800 font-bold mb-6 relative z-10 leading-relaxed">
                Connect the dots between your digestion, your mood, and your skin.
              </p>
              <ul className="space-y-3 mb-8 flex-grow relative z-10">
                 <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#7a2a33] shrink-0" /><span className="text-[15px] font-medium text-gray-700">Microbiome mapping</span></li>
                 <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#7a2a33] shrink-0" /><span className="text-[15px] font-medium text-gray-700">Absorption capabilities</span></li>
                 <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#7a2a33] shrink-0" /><span className="text-[15px] font-medium text-gray-700">Internal balance tracking</span></li>
              </ul>
              <button className="w-full py-4 rounded-xl border-2 border-[#7a2a33] bg-[#7a2a33] text-white font-bold uppercase tracking-widest text-[13px] hover:bg-[#5c1c24] hover:border-[#5c1c24] transition-colors shadow-md">
        ...
        <div className="w-full max-w-6xl mx-auto px-4 mb-24 grid grid-cols-1 md:grid-cols-2 gap-8">
           ...
           <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm text-center flex flex-col items-center">
              ...
              <p className="font-bold text-[#7a2a33] text-[13px] uppercase tracking-widest mb-6">In-clinic or in-club</p>
           ...
           <div className="bg-[#fcfaf7] p-10 rounded-[2.5rem] border border-[#e9e7dc] shadow-sm text-center flex flex-col items-center">
              ...
              <p className="font-bold text-[#7a2a33] text-[13px] uppercase tracking-widest mb-6">Expert Interpretation</p>
              <ul className="space-y-3 mb-8">
